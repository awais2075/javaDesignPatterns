...
public class AdminDashboardRenderer extends JPanel implements ListCellRenderer<User> {
    ...
    public AdminDashboardRenderer(ItemClickListener itemClickListener) {
    ...
    public Component getListCellRendererComponent(JList<? extends User> list,
        ...
        if (isSelected) {
            ...
            itemClickListener.onItemClicked(user, list.getSelectedIndex());
